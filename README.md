...
1. 项目概述
1.1 项目背景
随着数字内容创作和分享的日益普及，音视频格式转换成为了一个常见的需求。然而，大多数现有的格式转换工具依赖在线服务，这不仅存在数据安全风险，还因网络延迟导致转换效率低下。为了解决这些问题，我们开发了 AV Converter，一款高效、安全的本地音视频格式转换软件。
1.2 项目目标
...
1.	访问 AV Converter 官方下载页面（假设已发布）。
2.	下载最新版本的 AV Converter 源代码。
3.	解压下载的文件。
4.	打开命令行工具，切换到解压后的目录。
5.	运行以下命令启动软件：
python av_converter_pyside6.py
4. 使用方法
4.1 主界面介绍
